...
#import "MmsgBoxTableViewController.h"
#import "SWRevealViewController.h"
#import "MmsgBoxTableViewCell.h"
#import "MpersonalMsgViewController.h"
#import "MBProgressHUD.h"
#import "AppConstants.h"

@interface MmsgBoxTableViewController ()
...
@implementation MmsgBoxTableViewController
...
- (void)loadMessages {
    ...
    NSError *err;
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/%@", Server, @"merchant/messagesload"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MmsgBoxTableViewCell *cell = (MmsgBoxTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"mMsgBoxCell" forIndexPath:indexPath];
    // Configure the cell...
    NSManagedObject *object = [self.msgBoxList objectAtIndex:indexPath.row];
    cell.name.text = [object valueForKey:@"name"];
    cell.time.text = [object valueForKey:@"timeLastMsg"];
    cell.message.text = [object valueForKey:@"lastMsg"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"MpersonalChatSegue"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        NSManagedObject *object = [self.msgBoxList objectAtIndex:indexPath.row];
        
        //   UINavigationController *nv = [segue destinationViewController];
        MpersonalMsgViewController *mm = (MpersonalMsgViewController *)[segue destinationViewController];
