//
//  ServiceCatFindTableViewController.m
//  HomeHome
//
...
#import "ServiceCatFindTableViewController.h"
...
@interface ServiceCatFindTableViewController ()

@property NSArray *serviceCatList;

@end

@implementation ServiceCatFindTableViewController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (locS == nil || [locS isStringEmpty]) {
        NSString *alertMsg = @"Please enter your postal code in the Settings to search the matching services.";
        NSString *okTitle = @"OK";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ServiceCatFindCell" forIndexPath:indexPath];
    // Configure the cell...
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"ToServiceList"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        NSString *object = [self.serviceCatList objectAtIndex:indexPath.row];
        UINavigationController *nv = [segue destinationViewController];
        FindServiceViewController *mm = (FindServiceViewController *)[nv topViewController];
        
        mm.serviceCat = object;
