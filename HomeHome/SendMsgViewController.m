...
- (void)viewDidLoad {
 ...
 //   self.jobAttached.userInteractionEnabled = YES;
    self.toName.text = [self.serviceDict objectForKey:@"name"];
}
...
/*
- (void)chooseJob: (UITapGestureRecognizer *) tapGestureRecognizer {
    JobAttachTableViewController *controller = (JobAttachTableViewController *)[[UIStoryboard storyboardWithName:@"Custom" bundle:nil] instantiateViewControllerWithIdentifier:@"JobListAttach"];
...
- (void)sendMsgOnServer {
    ...
    NSString *emailToSend = [self.serviceDict objectForKey:@"email"];
  //  self.msgDetail
...
- (void)saveMsgCoreData:(NSString *)message withTime:(NSString *)time {
    ...
    [msg setValue:[self.serviceDict objectForKey:@"email"] forKey:@"email"];
    [msg setValue:[self.serviceDict objectForKey:@"name"] forKey:@"name"];
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"email == %@", [self.serviceDict objectForKey:@"email"]];
    ...
    if ([tempArr count] < 1) {
        ...
        [newChat setValue:[self.serviceDict objectForKey:@"email"] forKey:@"email"];
        [newChat setValue:[self.serviceDict objectForKey:@"name"] forKey:@"name"];
